...
export const LEARN_CHAPTERS: readonly LearnChapterMeta[] = [
  ...
  },
  {
    ...
    order: 4,
    part: 'readingMusic',
    load: () => import('./chapters/trebleStaff').then((m) => m.TREBLE_STAFF),
  },
  {
    ...
    order: 5,
    part: 'readingMusic',
    load: () => import('./chapters/bassAndGrandStaff').then((m) => m.BASS_AND_GRAND_STAFF),
  },
  {
    id: 'rhythmAndBeat',
    level: 'beginner',
    order: 6,
    part: 'readingMusic',
    load: () => import('./chapters/rhythmAndBeat').then((m) => m.RHYTHM_AND_BEAT),
  },
  {
    id: 'firstMelody',
    level: 'beginner',
  ...
  },
  {
    ...
    order: 2,
    part: 'gettingSerious',
    load: () => import('./chapters/keySignatures').then((m) => m.KEY_SIGNATURES),
  },
  {
    id: 'scalesBeyondC',
    level: 'intermediate',
    order: 3,
    part: 'gettingSerious',
    load: () => import('./chapters/scalesBeyondC').then((m) => m.SCALES_BEYOND_C),
  },
