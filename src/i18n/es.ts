...
export const es: Messages = {
  workflow: {
    listen: 'Escuchar',
    practiceLeft: 'Practicar izquierda',
    practiceRight: 'Practicar derecha',
    practiceBoth: 'Practicar ambas',
    ...
    upcoming: 'Próximas lecciones',
    updateAvailable: 'Actualización disponible',
    availableLessons: ({ count }) => `${count} lecciones disponibles`,
  },
  nav: {
    play: 'Tocar',
    learn: 'Aprender',
  ...
  transport: {
    ...
    modes: 'Modos',
    modesMenu: 'Modos de grabación y reproducción',
    ...
    simple: 'Simple',
    trainingLeft: 'Entrenamiento — mano izquierda',
    trainingRight: 'Entrenamiento — mano derecha',
    trainingBoth: 'Entrenamiento — ambas manos',
    waitingForYou: 'Esperando a que toques las teclas iluminadas',
  ...
  learn: {
    ...
    pedalPress: 'Ahora pisa el pedal.',
    pedalChange: 'Ahora cambia el pedal: levántalo y vuelve a pisarlo.',
    rotateHint: 'Esto necesita más teclas de las que caben en vertical: gira el teléfono.',
    ...
    playDegreeInKey: ({ key, degree }) => `En ${key}, toca el grado ${degree}.`,
  ...
  settings: {
    ...
    pianoSwitchFailed: ({ piano, current }) =>
      `No se pudo cargar ${piano}; sigue sonando ${current}.`,
    pianoVolume: 'Volumen del piano',
    reverb: 'Reverberación',
    reverbRoom: 'Sala de la reverberación',
    reverbRooms: {
      studio: 'Estudio',
      room: 'Habitación',
      hall: 'Auditorio',
    ...
    touchSensitivityLight: 'Ligera',
    touchSensitivityNormal: 'Normal',
    touchSensitivityFirm: 'Firme',
    touchSensitivityHint:
      'Ligera suena fuerte más arriba en cada tecla; Firme reserva las notas más fuertes para la parte inferior de la tecla.',
    accentHint: 'En un teclado de ordenador, mantén pulsada la tecla Mayús para acentuar una nota.',
    midiVelocityCurve: 'Curva de velocidad MIDI',
    midiCurveLight: 'Ligera',
    midiCurveNormal: 'Normal',
    midiCurveHeavy: 'Pesada',
    midiCurveHint: 'Ligera suena más fuerte con un toque suave; Pesada pide pulsar con más fuerza.',
    midiVelocityRange: 'Rango de velocidad MIDI',
    midiRangeNone:
      'Sin calibrar. Calibra para que tu nota más suave y tu nota más fuerte abarquen todo el rango del piano.',
    midiRangeSet: ({ min, max }) => `Calibrado: ${min}–${max} de 127.`,
    midiCalibrate: 'Calibrar',
    midiCalibrateReset: 'Restablecer',
    midiCalibrateCancel: 'Cancelar',
    midiCalibrateSoftest: 'Toca tu nota más suave…',
  ...
  repairs: {
    ...
    reverbRoomDropped:
      'Se descartó una sala de reverberación desconocida; la toma suena en «Habitación».',
