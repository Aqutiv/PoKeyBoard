...
export const fr: Messages = {
  ...
  learn: {
    ...
    pedalPress: 'Appuyez maintenant sur la pédale.',
    pedalChange: 'Changez maintenant la pédale : relevez-la, puis appuyez de nouveau.',
    rotateHint: 'Il faut plus de touches qu’il n’en tient en portrait : tournez votre téléphone.',
  ...
  settings: {
    ...
    touchSensitivityLight: 'Léger',
    touchSensitivityNormal: 'Normal',
    touchSensitivityFirm: 'Ferme',
    touchSensitivityHint:
      'Léger sonne fort plus haut sur chaque touche ; Ferme réserve les notes les plus fortes au bas de la touche.',
    accentHint: 'Sur un clavier d’ordinateur, maintenez la touche Maj pour accentuer une note.',
    midiVelocityCurve: 'Courbe de vélocité MIDI',
    midiCurveLight: 'Légère',
    midiCurveNormal: 'Normale',
    midiCurveHeavy: 'Lourde',
    midiCurveHint:
      'Légère joue plus fort sous un toucher délicat ; Lourde demande de frapper plus fort.',
    midiVelocityRange: 'Plage de vélocité MIDI',
    midiRangeNone:
      'Non calibrée. Calibrez pour que votre note la plus douce et votre note la plus forte couvrent toute la plage du piano.',
    midiRangeSet: ({ min, max }) => `Calibrée : ${min}–${max} sur 127.`,
    midiCalibrate: 'Calibrer',
    midiCalibrateReset: 'Réinitialiser',
    midiCalibrateCancel: 'Annuler',
    midiCalibrateSoftest: 'Jouez votre note la plus douce…',
