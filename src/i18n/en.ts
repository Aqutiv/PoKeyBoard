...
export const en: Messages = {
  ...
  transport: {
    ...
    undoPass: 'Undo pass',
    modes: 'Modes',
    modesMenu: 'Recording and playback modes',
    ...
    simple: 'Simple',
    trainingLeft: 'Training — left hand',
    trainingRight: 'Training — right hand',
    trainingBoth: 'Training — both hands',
    waitingForYou: 'Waiting for you to play the lit keys',
    countIn: 'Count-in…',
    recording: '● Recording',
  ...
  learn: {
    ...
    pedalPress: 'Now press the pedal.',
    pedalChange: 'Now change the pedal: lift it, then press it down again.',
    rotateHint: 'This needs more keys than fit upright — turn your phone sideways.',
    ...
    playDegree: ({ degree }) => `Play degree ${degree}.`,
    playDegreeInKey: ({ key, degree }) => `In ${key}, play degree ${degree}.`,
    readNotePrompt: 'Which note is this?',
    playWhatYouSee: 'Play the note shown.',
    chordQuality: { major: 'major', minor: 'minor' },
    chordQualityAnswer: { major: 'Major', minor: 'Minor' },
    chordName: ({ note, quality }) => `${note} ${quality}`,
    playChord: ({ chord }) => `Play ${chord}.`,
    hearIt: 'Hear it',
  ...
  settings: {
    ...
    touchSensitivityLight: 'Light',
    touchSensitivityNormal: 'Normal',
    touchSensitivityFirm: 'Firm',
    touchSensitivityHint:
      'Light plays loud higher up each key; Firm saves the loudest notes for the very bottom.',
    accentHint: 'On a computer keyboard, hold Shift to accent a note.',
    midiVelocityCurve: 'MIDI velocity curve',
    midiCurveLight: 'Light',
    midiCurveNormal: 'Normal',
    midiCurveHeavy: 'Heavy',
    midiCurveHint: 'Light plays louder for a gentle touch; Heavy asks you to strike harder.',
    midiVelocityRange: 'MIDI velocity range',
    midiRangeNone:
      'Not calibrated. Calibrate to stretch the span you really play, softest to loudest, over the piano’s whole range.',
    midiRangeSet: ({ min, max }) => `Calibrated to ${min}–${max} of 127.`,
    midiCalibrate: 'Calibrate',
    midiCalibrateReset: 'Reset',
    midiCalibrateCancel: 'Cancel',
    midiCalibrateSoftest: 'Play your softest note…',
  ...
  repairs: {
    ...
    reverbRoomDropped: 'Dropped an unknown reverb room; the take plays in Room.',
