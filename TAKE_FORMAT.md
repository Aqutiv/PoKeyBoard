...
- `quantization` `off | 1/8 | 1/16 | 1/32 | 1/64` — **display only**; raw performance timing is never quantized. An imported score arrives on the finest grid its own shortest value needs (1/16 floor).
